...
int main(int argc, char * argv[]) {
	...
	if (!ImageIO::loadImage("C:\\ti-software\\Image\\child-1.png", *input)) {
	...
	auto * img = executor->studentPreProcessing.stepToIntensityImage(*input);

	ImageIO::saveIntensityImage(*img, ImageIO::getDebugFileName("Desaturation.png"));
